import  {Client, ClientDocument  as ClientModel, SkillSet } from '../models/ClientModelNew';


class ClientRepositoryNew {
    async createOrUpdateClient(clientData: ClientModel):Promise<null> {
        try {
            ...
            if (existingClient) {
                ...
                existingClient.reason = clientData.reason;
...
export default new ClientRepositoryNew();
